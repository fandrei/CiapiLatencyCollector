...
namespace LatencyCollectorCore.Monitors
{
    public class AllServiceMonitor : AuthenticatedMonitor
    {
        ...
        private static PriceDTO GetPrice(Client client)
        {
            ...
            var streamingRecorder = new CIAPI.Streaming.StreamingRecorder<PriceDTO>(listener);
            ...
            finally
            {
                ...
                var messages = streamingRecorder.GetMessages();
                var serialized = client.Serializer.SerializeObject(messages);
